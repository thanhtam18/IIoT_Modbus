#ifndef __WEB_CONNECT_H
#define __WEB_CONNECT_H
...
extern boolean autoconnect_flag,
        global_,
        mb_flag,
        senddata_flag,
        status_flag,
        ...
        check_flag,
        setting_flag;
int  task_number, counter;

extern TaskHandle_t xModbusHandle, xSendHandle, xGetdataHandle, xStatusHandle, xFilemanager, xBoardHandle, xSettingHandle,
...
extern String ssid;
extern String pass;
extern uint16_t value_mb[1];
extern uint16_t au16data[16];
extern uint16_t au16datafr[5];
extern int datafr[3], dataplc[10];
...
extern void reconnect(void *pvParameters);
#endif